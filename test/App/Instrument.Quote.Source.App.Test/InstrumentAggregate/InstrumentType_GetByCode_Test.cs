...
public class InstrumentType_GetByCode_Test : BaseDbTest
{

  public InstrumentType_GetByCode_Test(ITestOutputHelper output) : base(output)
  {

  }
  [Fact]
  public async void WHEN_request_by_code_THEN_get_correct_answer()
  {
    #region Array
    ...
    using (var act_scope = this.global_sp.CreateScope())
    {
      ...
      assertedResult = await usedSrv.GetByAsync("Currency");
    }
  ...
  [Fact]
  public async void WHEN_request_by_wrong_code_THEN_notFound()
  {
    #region Array
    Logger.LogDebug("Test ARRAY");
    ...
    using (var act_scope = this.global_sp.CreateScope())
    {
      var sp = act_scope.ServiceProvider;
      var usedSrv = sp.GetRequiredService<IInstrumentTypeSrv>();
      assertedResult = await usedSrv.GetByAsync("oeueou");
    }
