...
public class GetUntillDateTimeFor_Test : ExpectationsTestBase
{

  public GetUntillDateTimeFor_Test(ITestOutputHelper output, LogLevel logLevel = LogLevel.Debug) : base(output, logLevel)
  {
    ...
    get
    {
      ...
      yield return new object[] {
        ...
        new Dictionary<DateTime, IEnumerable<DateTime>> {
          ...
          {
            new DateTime(2023,6,26,1,00,0),
            new List<DateTime>(){
              new DateTime(2023,6,26,0,45,0),
              new DateTime(2023,6,26,0,46,7),
              new DateTime(2023,6,26,0,59,59),
            }
          },
          {
      ...
      yield return new object[] {
        ...
        new Dictionary<DateTime, IEnumerable<DateTime>> {
          ...
          },
          {
            new DateTime(2023,6,26,1,00,0),
            new List<DateTime>(){
              new DateTime(2023,6,26,0,50,0),
              new DateTime(2023,6,26,0,56,7),
              new DateTime(2023,6,26,0,59,59),
            }
          },
          {
      ...
      yield return new object[] {
        ...
        new Dictionary<DateTime, IEnumerable<DateTime>> {
          ...
          },
          {
            new DateTime(2023,6,26,1,0,0),
            new List<DateTime>(){
              new DateTime(2023,6,26,0,59,0),
              new DateTime(2023,6,26,0,59,7),
              new DateTime(2023,6,26,0,59,59),
            }
          },
          {
  ...
  public void WHEN_give_datetime_THEN_return_correct_convertatino(TimeFrame.Enum timeframe, Dictionary<DateTime, IEnumerable<DateTime>> testCases)
  {
    ...
    foreach (var kvp in testCases)
    {
      ...
      foreach (var usingDateTime in kvp.Value)
      {
        ...
        var assertedDataTime = timeframe.GetUntillDateTimeFor(usingDateTime);
