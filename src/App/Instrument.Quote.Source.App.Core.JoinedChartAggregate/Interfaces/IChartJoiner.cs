...
{
  public static async Task<JoinedChart> JoinTo(this IChartJoiner joiner, Chart baseChart, TimeFrame targetTimeFrame, DateTime from, DateTime untill, CancellationToken cancellationToken)
  {
    return await joiner.JoinToAsync(baseChart, targetTimeFrame, new DateTimePeriod(from, untill), cancellationToken);
  }

  public static async Task<JoinedChart> JoinTo(this IChartJoiner joiner, Chart baseChart, TimeFrame targetTimeFrame, CancellationToken cancellationToken)
  {
